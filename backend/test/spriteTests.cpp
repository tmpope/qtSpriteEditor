...
TEST(BasicCases, InstantiateGifImport2)
{
	Sprite sprite("./Samus_Sprite.gif", true);
	EXPECT_EQ(64, sprite.getHeight());
	EXPECT_EQ(64, sprite.getWidth());
